...
cohen.d(rctable$cond1_mean, rctable$cond2_mean, paired = T, na.rm = T)$estimate
#software
cohen.d(softwaretable$cond1_mean, softwaretable$cond2_mean, paired = T, na.rm = T)$estimate
